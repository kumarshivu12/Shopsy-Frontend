...
//components
import { ITEMS_PER_PAGE, SORT_OPTIONS } from "../../../app/constants";
...
function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      if (newFilter[section._id]) {
        newFilter[section._id].push(option.value);
      } else {
        newFilter[section._id] = [option.value];
      }
    } else {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProductsAsync({ filter, sort, pagination, admin: true }));
